...
/**
 * An activity representing a list of Organs. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link OrganDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 */
public class OrganListActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        View recyclerView = findViewById(R.id.organ_list);
        assert recyclerView != null;
        setupRecyclerView((RecyclerView) recyclerView);

        if (findViewById(R.id.organ_detail_container) != null)
        {
            ...
            extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder>
    {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
        {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.organ_list_content, parent, false);
                ...
                public void onClick(View v)
                {
                    if (mTwoPane)
                    {
                        ...
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.organ_detail_container, fragment)
                                .commit();
                    }
                    else
                    {
